  ...
  (defun check-tolerance (particle tolerance-node-list tolerance stepsize ) 
    ...
    (let ((d2y)
          ...
          ;; (nodes-per-slice 2) ;; for unit testing only should be removed after
                ...
                ;;(print "--particle--")
                ;;(print particle) 
                ;;(print "--tolerance_node-list--")
                ;;(print tolerance-node-list)
                ;;(print "--tolerance--")
                ;;(print tolerance)
                ;;(print "--stepsize--")
                ;;(print stepsize)
      ...
      (if (LOOP FOR node IN tolerance-node-list
          ...
          (progn
            ...
            ;;(print "NIL")
            ;;(print "--stepsize--")
            ;;(print (min (* (sqrt (* 2 (/ tolerance d2y))) SafetyFactor) (* stepsize M1)))
            ;;(print "***********end**********")
          ...
          (progn
            ...
            (let ((newstep (min (* stepsize M2) (* (sqrt (/ (* 2 tolerance) d2y)) SafetyFactor))) 
              ...
              ;;Nazli
              ;;(print "--newstep--")
              ;;(print (min (* stepsize M2) (* (sqrt (/ (* 2 tolerance) d2y)) SafetyFactor)))
              ;;(print "--values--")
              ;;(print "T")
              ;;(print "--newstep--")
              ;;(print (min (* (sqrt (* 2 (/ tolerance d2y))) SafetyFactor) (* newstep M1)))
              ;;(print "***********end**********")
